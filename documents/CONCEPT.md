...
7. ~~**Binder multi-select + move**~~ ✅ — Shift+Up/Down selection, Cmd+M move-to-folder picker, bulk delete, shortcut reference panel (Cmd+/)
8. **@-mention linking** — autocomplete in text blocks, creates entity_link dossier attachment
